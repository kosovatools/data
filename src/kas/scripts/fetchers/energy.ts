import { FUEL_SPECS, FuelSpec } from "../../types/constants";
...
import { EnergyRecord, FuelRecord } from "../../types/energy";
import type { FuelMetric as FuelMetricKey } from "../../types/energy";
