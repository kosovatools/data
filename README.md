...
- `packages/data`: shared dataset package (types + registry + fetcher) (`@kosovatools/data`)
...
- Shared dataset typings and the dataset registry/fetcher live under `packages/data` (packaged as `@kosovatools/data` for the site to consume via a file dependency).
