import { FUEL_SPECS, FuelSpec } from "@kosovatools/data";
...
import { EnergyRecord, FuelRecord } from "@kosovatools/data";
import type { FuelMetric as FuelMetricKey } from "@kosovatools/data";
